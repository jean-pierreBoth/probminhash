...
This algorithm applies a bottom-k strategy to extract k minimum hashes, using only one hash function as used by Broder 1997. However, in a followup paper, Broder et.al., 1998, this strategy was abandoned because it is not locality sensitive hashing. We implemented it here for benchmark purposes. 
